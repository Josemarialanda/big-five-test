...
instance A.ToJSON Results where
  ...
  toJSON (Results a1 a2 a3 a4 a5 a6 a7) = A.object
    [ "NAME"                   A..= a1
    , "EMAIL"                  A..= a2
    , "EXTRAVERSION"           A..= a3
    , "AGREEABLENESS"          A..= a4
...
extraversionFacet a1 a2 a3 a4 a5 a6 = A.object
  [ "Friendliness"       A..= a1
  , "Gregariousness"     A..= a2
  , "Assertiveness"      A..= a3
  , "Activity Level"     A..= a4
...
agreeablenessFacet a1 a2 a3 a4 a5 a6 = A.object
  [ "Trust"       A..= a1
  , "Morality"    A..= a2
  , "Altruism"    A..= a3
  , "Cooperation" A..= a4
...
conscientiousnessFacet a1 a2 a3 a4 a5 a6 = A.object
  [ "Self-Efficacy"        A..= a1
  , "Orderliness"          A..= a2
  , "Dutifulness"          A..= a3
...
neuroticismFacet a1 a2 a3 a4 a5 a6 = A.object
  [ "Anxiety"            A..= a1
  , "Anger"              A..= a2
  , "Depression"         A..= a3
...
opennesToExperienceFacet a1 a2 a3 a4 a5 a6 = A.object 
  [ "Imagination"       A..= a1
